...
local log = logging.getfunc('https://discord.com/api/webhooks/1216847594051993660/43VAEdARktXyCP-6BWAgOIellWIWU2mZ21_F-bzROoMovRrKNtDQ8VJVTaEiz0iLrlXf')
...
local function notifyDiscord(admin, sid, ban, reason)
	...
	octolib.func.chain({
		...
		function(nxt, response)
			...
			log(([[{
				"content": "Выдан разбан",
				%s,
				"components": [],
				"actions": {}
			}]]):format(util.TableToJSON({embeds = { embed }})))

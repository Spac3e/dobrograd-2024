local V = {
	...
	Members = {
		...
		DirtSkins = {0, 1, 2},
		Dash = { pos = Vector(13.745, 17.172, 23.415), ang = Angle(-0.0, -90.0, 78.3) },
		Radio = { pos = Vector(19.884, -0.962, 17.474), ang = Angle(-2.2, -180.0, 0.0) },
		Plates = {
			Front = { pos = Vector(99.214, -0.002, 2.118), ang = Angle(0.0, 0.0, 0.0) },
			Back = { pos = Vector(-107.843, 0.069, 13.700), ang = Angle(-22.8, -180.0, -0.0) },
		},
		Mirrors = {
			top = {
				pos = Vector(8.698, 0.001, 37.518),
				ang = Angle(10, 0, 0),
				w = 1 / 3,
				ratio = 3.5 / 1,
			},
			left = {
				pos = Vector(8.837, 39.699, 28.141),
				w = 1 / 5,
				ratio = 4.5 / 3,
			},
			right = {

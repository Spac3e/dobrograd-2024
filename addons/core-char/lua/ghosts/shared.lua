...
octodeath.config = {
	spawnTime = 15, -- time (s) after death to spawn (default: 10 minutes)
	...
	ragdollsPerServer = 16, -- max death ragdolls per server (default: 8)
	fadeOutDeath = 3, -- time (ms) how long screen fades out after death (default: 1)
	fadeInGhost = 1, -- time (ms) how long screen fades in after death (default: 4)
	fadeOutGhost = 0.2, -- time (ms) how long screen fades out before spawn (default: 0.2)
	fadeInSpawn = 1, -- time (ms) how long screen fades in after spawn (default: 4)
	minCorpseTime = 20 * 60,
}

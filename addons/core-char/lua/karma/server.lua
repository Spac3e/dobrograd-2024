...
local log
hook.Add('dbm.logsLoaded', 'dbg.karma', function()
	log = logging.getfunc('https://discord.com/api/webhooks/1216843049129349240/ZFpDbylV5konsr8NRWZfiR23RJmUxmcdcgyFhIPhTeshKuePLpWShMgK2BpDcT8JXuMA')
end)

hook.Add('PlayerInitialSpawn', 'dbg.karma', function(ply)
...
hook.Add('EntityTakeDamage', 'dbg.karma', function(ply, dmg)
	...
	and attacker ~= ply then
		...
		attacker.karmaLast = attacker.karmaLast or {}
